...
Grab `PhantomSetup-v1.1.1.msi` from the [releases page](https://github.com/HarperZ9/phantom/releases/latest),
along with `SHA256SUMS.txt`. Verify the download before running it (see
[`signature-verification.md`](../signature-verification.md)).

## 2. Run the installer

Double-click `PhantomSetup-v1.1.1.msi` and accept the UAC prompt.
...
You should see `phantom 1.1.1`. If Windows reports "phantom is not
